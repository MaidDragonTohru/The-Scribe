...
exports.commands = {
	...
	about: function(arg, by, room, con) {
		...
		text += 'Writing Bot: fork of Roleplaying Bot by Morfent, with custom Writing Room commands AxeBane and SolarisFox.';
	...
	axe: function(arg, by, room, con) {
		...
		switch (rand) {
	 		case 1: text += "AxeBane is not on your side. Run."; break;
	  		case 2: text += "\'Tis but a flesh wound!"; break;
			case 3: text += "I\'m sorry, but I don\'t understand stupid."; break;
			...
			case 11: text += "Sorry, but the cake is a lie."; break;
			...
			case 21: text += "AxeBane is on your side, thus you have nothing to fear."; break;
		}
		this.say(con, room, text);
	},
	...
	wotd: function(arg, by, room, con) {
		...
		if (!this.RP[room].wotdCalled) {
			...
			setTimeout(function() { delete self.RP[room].wotdCalled; }, 60 * 1000);
		}
	...
	poll: function(arg, by, room, con) {
		...
		if (this.RP[room].pollCalled) {
			...
			setTimeout(function() { delete self.RP[room].pollCalled; }, 60 * 1000);
		}
	...
	fossil: function(arg, by, room, con) {
		...
		this.say(room, text + '/me showers Golden in fossils.');
	},
	...
	drive: function(arg, by, room, con) {
		...
		this.say(con, room, text + 'Community Drive: http://bit.do/wdrive');
	},
	contests: 'events',
	contest: 'events',
